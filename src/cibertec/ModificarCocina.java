...
public class ModificarCocina extends JInternalFrame {
	...
	public ModificarCocina() {
		...
		jprecio = Double.parseDouble(txtPrecio.getText());
		jancho = Double.parseDouble(txtAncho.getText());
		jalto = Double.parseDouble(txtAlto.getText());
		jfondo = Double.parseDouble(txtFondo.getText());
		jquemadores = Double.parseDouble(txtQuemadores.getText());
		}
}
